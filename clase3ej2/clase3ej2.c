/*
 ...
 Author      : Julio
Consigna:
Hacer un menú con las funciones sumar, restar, multiplicar y dividir en el que se pueda
elegir que operación realizar.
...
int main(void) {
	...
	do
	{
	printf("Selecione la operación a realizar ingresando la opción deseada: [*+* , *-* , *x*, */*]\n");
	fflush(stdin);
	scanf("%c",&operacion);
