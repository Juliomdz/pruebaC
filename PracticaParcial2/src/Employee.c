...
int employee_loadNew(char* nombre,int* horasTrabajo,int* sueldo,Dictionary* pArrayListEmployee){
    int retorno=-1;
...
/**
int employee_searchMaxIdEmployee(Dictionary* pArrayListEmployee,int* maxId){
    int retorno=-1;
    int longitud;
    int i;
    int id;
    Employee* pEmpleado;
    LinkedList* listaAux=dict_get;
